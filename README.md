...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/empty-bar-0e08)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/empty-bar-0e08
```

A live public deployment of this template is available at [https://empty-bar-0e08.templates.workers.dev](https://empty-bar-0e08.templates.workers.dev)
